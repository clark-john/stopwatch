 ...
 */var J;((J=window.HTMLSlotElement)===null||J===void 0?void 0:J.prototype.assignedElements)!=null;class vt extends Event{constructor(t,e){super(t);const{time:s,reset:i}=e;this.time=s,this.reset=i||!1}}var jt=Object.defineProperty,kt=Object.getOwnPropertyDescriptor,gt=(r,t,e,s)=>{for(var i=s>1?void 0:s?kt(t,e):t,o=r.length-1,n;o>=0;o--)(n=r[o])&&(i=(s?n(t,e,i):n(i))||i);return s&&i&&jt(t,e,i),i};let z=class extends v{constructor(){super(),this.name="",this.render=()=>$`<button class="${this.name.toLowerCase()}">${this.name}</button>`}};z.styles=C`
  ...
  `;O([f({type:Boolean})],y.prototype,"isStarted",2);O([f({type:Number})],y.prototype,"milliseconds",2);O([f({type:Number})],y.prototype,"seconds",2);O([f({type:Number})],y.prototype,"minutes",2);O([f({type:Number})],y.prototype,"hours",2);y=O([P("stop-watch")],y);const zt=r=>{let t="";for(let o of r){const{time:n,number:d}=o;t+=`${d}, ${n}
